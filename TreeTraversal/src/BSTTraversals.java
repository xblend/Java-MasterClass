...
public class BSTTraversals<T extends Comparable<? super T>> {
    ...
    private void preorderTraversal(List<T> list, BSTNode<T> node){
        if(node!=null){
    ...
    private void inorderTraversal(List<T> list, BSTNode<T> node){
        if(node!=null){
    ...
    private void postorderTraversal(List<T> list, BSTNode<T> node){
        if(node!=null){
