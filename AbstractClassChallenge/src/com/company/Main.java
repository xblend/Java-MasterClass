...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String stringData = "Russia India China Nepal Bhutan USA Pakistan SriLanka Afghanistan Austria";
        ...
        list.removeItem(new Node("Russia"));
        list.traverse(list.getRoot());

        list.removeItem(new Node("Bhutan"));
        list.traverse(list.getRoot());

        list.removeItem(new Node("China"));
        list.removeItem(new Node("Nepal"));
        list.removeItem(new Node("USA"));
        list.traverse(list.getRoot());

        list.removeItem(new Node("Pakistan"));
        list.traverse(list.getRoot());
        list.removeItem(new Node("Austria"));
        list.traverse(list.getRoot());
        list.removeItem(new Node("SriLanka"));
        list.traverse(list.getRoot());
        ...
        // Create a string data array to avoid typing loads of addItem instructions:
        String treeData = "Russia India China Nepal Bhutan USA Pakistan SriLanka Afghanistan Austria";

        String[] dataTree = treeData.split(" ");

        for (String s : dataTree) {
            tree.addItem(new Node(s));
        }
        System.out.println("Root="+tree.getRoot().getValue());
        System.out.println("Tree node values:");
        tree.traverse(tree.getRoot());
        tree.removeItem(new Node("Pakistan"));
        System.out.println("Tree node values:");
        tree.traverse(tree.getRoot());
        tree.removeItem(new Node("Russia"));
        System.out.println("Tree node values:");
        tree.traverse(tree.getRoot());
        tree.removeItem(new Node("USA"));
        tree.removeItem(new Node("Nepal"));
        System.out.println("Tree node values:");
        tree.traverse(tree.getRoot());
        tree.removeItem(new Node("Bhutan"));
        tree.removeItem(new Node("Afghanistan"));
        System.out.println("Tree node values:");
        tree.traverse(tree.getRoot());
    }
}
